...
@section('content')
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
        @foreach($costumes = DB::table('costumes')->where('type_id', '=', $costume_type->id)->paginate(5) as $costume)
                ...
                <td style="text-align: center">
                    ...
                    @if($costume->availability)
                        <form method="POST"
                            ...
                            @csrf
                            <button class="btn btn-success" type="submit"><span class="glyphicon glyphicon-shopping-cart" style="text-align: center; color: #ffffff"></span></button>
