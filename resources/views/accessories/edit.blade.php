...
@section('headline', 'Edit accessory')

@section('content')

    <form method="POST" action="../{{ $accessory->id }}">
        @method('PATCH')
        @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="name" type="text"
                       ...
                       name="name" value="{{ $accessory->name }}">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="description" type="text"
                       ...
                       name="description" value="{{ $accessory->description }}">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="dateOfManufacture" type="date"
                       ...
                       value="{{ $accessory->dateOfManufacture }}" required>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                ...
                <select name="employee_id" class="form-control{{ $errors->has('employee_id') ? ' is-invalid' : '' }}" value="{{ $accessory->employee_id }}" required>
                    @foreach(\App\Employee::all() as $employee)

                        <option value="{{$employee->id}}" {{($accessory->employee_id == $employee->id) ? 'selected' : ''}}>{{ \App\User::find($employee->id)->name . ' ' . \App\User::find($employee->id)->surname }}</option>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="availability" type="checkbox"
                       ...
                       style="width: auto;" name="availability" {{($accessory->availability) ? 'checked' : ''}}>
